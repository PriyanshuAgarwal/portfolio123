  ...
  return (
    <div className="navbar-container">
      <ul>
        ...
        <li onClick={() => this.props.setView("resume")}>
        ...
        <li onClick={() => this.props.setView(3)}>
        ...
        <li onClick={() => this.props.setView(4)}>
