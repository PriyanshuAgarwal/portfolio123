    ...
    <div className="navbar-container">
      <ul>
        ...
        <li onClick={() => this.props.changeView(4)}>
          <div className={"menu-item " + (this.props.currentViewIndex === 4 ? "menu-item-active": "")}>
